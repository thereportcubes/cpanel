...
Route::get('other-industries.xml',[XmlController::class,'xml_industries']);
Route::get('other-regions.xml',[XmlController::class,'xml_regions']);
...
Route::group(['prefix' => '{locale}', 'middleware' => 'setlocale'], function () {
    ...
    Route::get('/forget-password', [ForgotPasswordController::class, 'showForgetPasswordForm'])->name('forget-password');
    Route::post('/forget-password', [ForgotPasswordController::class, 'submitForgetPasswordForm'])->name('forget.password.post'); 
})->where('locale', implode('|',config('app.available_languages')));
