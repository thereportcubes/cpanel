...
class AppHelper
{
    ...
    $full = '★';
    $half = '⯨'; // or use '½' or SVG icon for better half-star
    $empty = '☆';
    ...
    return '<span class="star-rating" style="color:#f4b400; font-size:18px;">' . $stars . ' <span style="color:#666; font-size:14px;">' . number_format($rating, 1) . '</span></span>';
}
}