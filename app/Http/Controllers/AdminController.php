...
class AdminController extends Controller
{
  ...
  public function save_report(Request $req){
    ...
    if(!empty($Ques)){
      ...
      $report->list_of_figure           = $req->list_of_figure;
      $report->list_of_table           = $req->list_of_table;
      ...
      $report->script_code =  $req->script_code;
...
public function edit_seo_page($id){
   if($this->checkRole() === false){
          ...
          $seo_content = Seo_Pages::where(['page_type'=>$list->page_key,'static_pages'=>'1'])->first(); 
...
##### Banner
    ...
    public function save_banner(Request $req){
        ...
        if(isset($req->banner_mobile_image)){
          $imageName = time().'.'.$req->banner_mobile_image->extension();  
