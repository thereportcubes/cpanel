...
<section class="custom-container ab-about-hero text-justify" style="padding: 30px 0px !important;">    
    ...
    <div class=" ab-col ab-col-desktop-6 ab-col-tablet-12 text-center" >
        <img src="{{asset('assets/images/icons/Handshake.png')}}" class="why_icon" alt="handshake-image">
    ...
    <div class=" ab-col ab-col-desktop-6 ab-col-tablet-12 text-center" >
        <img src="{{asset('assets/images/icons/Handshake.png')}}" class="why_icon" alt="handshake-technology">
    ...
    <div class=" ab-col ab-col-desktop-6 ab-col-tablet-12 text-center" >
        <img src="{{asset('assets/images/icons/icon-document.png')}}" class="why_icon" alt="document-image">
    ...
    <div class=" ab-col ab-col-desktop-6 ab-col-tablet-12 text-center" >
        <img src="{{asset('assets/images/icons/icon-document.png')}}" class="why_icon" alt="document-client-image">
