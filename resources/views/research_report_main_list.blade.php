                              ...
                              <div class="product-item-content">
                                 <div class="ab-product-thumbnail-book-binder left report_store">
                                    <div class="product-img-box">
                                       <span class="related-image-report">Report</span>
                                       <p class="related-image-title">
                                       <?php echo substr(html_entity_decode(strip_tags($d->title)),0,30); ?></p>                      
                                       </p>
                                       ...
                                       <span class="book-years" style="color:#000 ;font-size: 8px;right: 18px;bottom: 3px;">{{ Carbon\Carbon::parse($d->report_post_date)->format('M Y') }}</span>
                                    </div>
