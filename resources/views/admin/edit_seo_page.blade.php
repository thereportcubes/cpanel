                    ...
                    <div class="card-body">
                        ...
                        <form action="{{url('TRC/11/update-seo-page')}}/{{request()->segment(4)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                              ...
                              <option value="shopping-basket" @if($list->page_key == 'shopping-basket') {{"selected"}} @endif>Shopping Basket</option>
                              
                              <option value="signin" @if($list->page_key == 'signin') {{"selected"}} @endif>Sign In</option>
                              
                              <option value="forget-password" @if($list->page_key == 'forget-password') {{"selected"}} @endif>Forget Password</option>
                                    </select>
                                </div>
                               <div class="form-group col-md-12">
