                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select onchange ="getCountryData()"  name="region_id" class="form-control" id="region" >
                                        ...
                                        @foreach($region as $cat)
                                            <option value="{{$cat->id}}" @if($cat->id == $list->region_id) {{"selected"}} @endif>{{$cat->region_name}}</option>
                                        @endforeach    
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="country_id" class="form-control" id="country" >
                                        ...
                                        <option value="{{$sc->id}}" @if($sc->id == $list->country_id) {{"selected"}} @endif>{{$sc->country_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                              ...
                              <!--   <div class="form-group col-md-3">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="hidden" name="infographic_img_H" class="form-control" value="{{$infoimage}}">
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                         <label for="infographic_title">Infographic Alt</label>
                                             <input type="text" name="infographic_title" placeholder="Infographic title" class="form-control" id="infographic_title" value="{{ $infographic_data->img_alt_tag ?? '' }}">
                                        </div>
                                <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="list_of_figure">{{$list->list_of_figure}}</textarea>
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="description">List of Table</label>
                                    <textarea name="list_of_table">{{$list->list_of_table}}</textarea>
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="description">Companies Mentioned</label>
                                    <textarea name="companies_mentioned">{{$list->companies_mentioned}}</textarea>
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="script_code"  class="form-control" rows = "4" cols="50">{{$list->script_code}}</textarea>
                                </div>
