                ...
                <div class="card card-statistics">
                    <div class="card-header">
                        <div class="card-heading">
                            <form action="{{url('TRC/11/bulk-report-upload')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">                                
                    ...
                    <div class="card-header">
                        <div class="card-heading">
                            <div class="row">
                                ...
                                <div class="col-md-2 text-right"><a href=" {{route('TRC/11/report_list')}}"><button type="button" class="btn btn-info ">All Reports</button></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        @endif
                        <form action=" {{route('TRC/11/save_report')}}" method="post" id="myForm" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="title">H1 *</label>
                                    <input type="text" name="title"  placeholder="Title" class="form-control"   id="title" value="{{ old('title') }}"   required>
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="title">H2 *</label>
                                    <input type="text" name="heading2"  placeholder="Title" class="form-control" required="required"  id="title2"  value="{{ old('heading2') }}" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="category"> Category</label>
                                    <select onchange ="getSubCatData()"  name="category_id" class="form-control" id="category" required>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" name="no_of_page"  placeholder="Number of page" class="form-control" id="page" value="{{ old('no_of_page') }}" required>
                                </div>
                               <!--  <div class="form-group col-md-6">
                                    <label for="page">Report Code</label>
                                    <input type="text" name="report_code" value="" placeholder="Report Code" class="form-control" id="report_code" value="{{ old('report_code') }}" required>
                                </div> -->
                                <div class="form-group col-md-6">
                                    <label for="page">Single License Price</label>
                                    <input type="text" name="single_user_license"  placeholder="Single License Price" class="form-control" id="single_user_license" value="{{ old('single_user_license') }}" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="page">Special Single License Price</label>
                                    <input type="text" name="special_single_licence_price"  placeholder="Single License Price" class="form-control" id="special_single_licence_price" value="{{ old('special_single_licence_price') }}">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="page">Group license Price</label>
                                    <input type="text" name="group_user_license" placeholder="Group License Price" class="form-control" id="group_user_license" value="{{ old('group_user_license') }}">
                                </div>
                                <div class="form-group col-md-6">
                               ...
                               <!--  <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="date" name="report_post_date" id = "report_post_date" class="form-control" required value="{{ old('report_post_date') }}">
                                </div>
                              ...
                              <!--   <div class="form-group col-md-3">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="Description2" >{{ old('Description2') }}</textarea>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                 ...
                                 <div class="form-group col-md-6">
                                    <label for="page">Infographic Alt</label>
                                    <input type="text" name="infographic_title" placeholder="infographic alt" class="form-control" id="infographic_title">
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                  ...
                                  <div class="form-group col-md-12">
                                    <label for="companies_mentioned">Companies Mentioned</label>
                                    <textarea name="companies_mentioned"></textarea>
                                </div>
                                    <div class="form-group col-md-12">
                                    <label for="description">List of Figure</label>
                                    <textarea name="list_of_figure"></textarea>
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="description">List of Table</label>
                                    <textarea name="list_of_table"></textarea>
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="description">Script Code</label>
                                    <textarea name="script_code"  class="form-control" rows = "4" cols="50"></textarea>
                                </div>
...
<script>
    ...
    CKEDITOR.replace('list_of_figure');
    CKEDITOR.replace('list_of_table');
</script>
