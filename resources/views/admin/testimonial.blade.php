               ...
               <div class="ml-auto d-flex align-items-center">
                  <nav>
                     <ol class="breadcrumb p-0 m-b-0">
                        ...
                        <li class="breadcrumb-item active text-primary" aria-current="page"> Add New Testimonial</li>
                     </ol>
                  </nav>
               </div>
            </div>
         ...
         <div class="col-xl-12">
            <div class="card card-statistics">
               ...
               <div class="card-body">
                  ...
                  <br>
                  @endif
                  <form action=" {{route('TRC/11/save_testimonial')}}" method="post" enctype="multipart/form-data">
                     @csrf
                     <div class="form-row">
                        <div class="form-group col-md-12">
                           <label for="title">Name*</label>
                           <input type="text" name="client_name" value="" placeholder="Client Name" class="form-control" required="required"  id="title">
                        </div>
                     <!--    <div class="form-group col-md-12">
                           <label for="title">Heading*</label>
                           <input type="text" name="title" value="" placeholder="Designation" class="form-control" required="required"  id="title">
                        </div>
                        <div class="form-group col-md-12">
                           <label for="title">Country</label>
                           <input type="text" name="client_country" value="" placeholder="Country" class="form-control" required="required"  id="title">
                        </div> -->
                        <div class="form-group col-md-12">
                        ...
                        <div class="form-group col-md-12">
                           ...
                           <input type="text" name="rating" value="" placeholder="rating" class="form-control" required="required"  id="rating">
                        </div>
                        <div class="form-group col-md-12">
