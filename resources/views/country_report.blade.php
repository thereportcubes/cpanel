  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <h2 style="font-size: 18px; padding-bottom: 2px; color: white;">{{$subcat_name_h2}}</h2>
                </div>
    </div>
  </div>
</section>
    ...
    <div class="row">
      <div class="col-md-3 sm-100">
        ...
        <div class="filter when-scroll ">
          <h3 style="font-size: 18px; padding-bottom: 15px; font-weight:bold; color: var(--primary-color);">Target Inustry
          </h3>
          ...
          <div class="filter-item">
            ...
            <div id="collapse_{{$cat->id}}" class="panel-collapse in collapse" role="tabpanel"
              aria-labelledby="headingOne_{{$cat->id}}" style="display: none">
          ...
          <div class="filter-item">
            <a href="#" class="filter-cate-tilte" data-toggle="collapse" data-parent="#accordionMenu"
              ...
              <input type="checkbox" name="region" value="{{ $cat->id }}"
                onclick="toggleSubCategories(this, {{$cat->id}}, 'region')" {{$category->id == $cat->id ? 'checked' :
              ''}}> {{$cat->region_name}}
            </a>
            <div id="collapse_{{$cat->id}}" class="panel-collapse collapse" role="tabpanel"
              aria-labelledby="heading_{{$cat->id}}" style="display: {{$category->id == $cat->id ? 'block' : 'none'}};"">
              <div class=" panel-body">
              ...
              <li>
                <input type="checkbox" name="country" data-country="{{$cat->id}}" value="{{$country->id}}"
                  onchange="updateResults()" {{$country->id == $subcat_id ? 'checked' : ''}}>
