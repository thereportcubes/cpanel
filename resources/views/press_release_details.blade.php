...
<section class="mini-banner">
   <div class="container">
      <div class="row">
         <div class="col-md-12">
         <p class="mb-0 mini-banner-title">Press Release Details</p>
         <h1 style="font-size: 18px; padding-bottom: 2px; color: white;">Get Information on Latest Press Release</h1>
         </div>
      </div>
   </div>
</section>
          ...
          <div class="product-item-small product-item-mobile  press-item col-md-9" style="width:100%">
                        ...
                        <div class="product-item-content" style=" margin-top: 15px;">
                           <div class="content margin-zero" style="text-align: justify;">
                              <h2 class="title f-arial"><a href="#" style="color:var(--primary-color);">{{$press->heading}}</a></h2>
